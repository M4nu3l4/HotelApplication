...
{
    [Authorize(Roles = "Amministrativo, AddettoPrenotazioni")]
    public class CamereController : Controller
    {
        private readonly HotelApplicationContext _context;

        public CamereController(HotelApplicationContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CameraId,Numero,Tipo,Prezzo,Fumatori,Disabile,MezzaPensione,PensioneCompleta")] Camera camera)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CameraId,Numero,Tipo,Prezzo,Fumatori,Disabile,MezzaPensione,PensioneCompleta")] Camera camera)
        {
